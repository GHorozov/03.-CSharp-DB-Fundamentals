...
using P02_DatabaseFirst.Data.Models; //add using with path to models where classes are located.  

namespace P02_DatabaseFirst.Data //change name bacause I move SoftUniContext to Data directory.
{
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer(@"Server=DESKTOP-QIOC91F\SQLEXPRESS;Database=SoftUni;Integrated Security=True;");
            }
        }
