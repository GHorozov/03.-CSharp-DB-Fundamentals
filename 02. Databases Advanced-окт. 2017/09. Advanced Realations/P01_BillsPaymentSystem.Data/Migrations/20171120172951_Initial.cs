...
namespace P01_BillsPaymentSystem.Data.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CreditCardId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ExpirationDate = table.Column<DateTime>(nullable: false, defaultValueSql: "GETDATE()"),
            ...
            migrationBuilder.Sql("ALTER TABLE Paymentmethods ADD CONSTRAINT CK_CreditCardId_BankAccountId CHECK((CreditCardId IS NOT NULL AND BankAccountId IS NULL) OR(CreditCardId IS NULL AND BankAccountId IS NOT NULL))");
        }
