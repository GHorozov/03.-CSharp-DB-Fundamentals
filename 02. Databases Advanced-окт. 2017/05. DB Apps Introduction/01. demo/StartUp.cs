...
namespace _01.demo
{
    public class StartUp
    {
        public static void Main(string[] args)
        {
            ...
            var connection = new SqlConnection(builder.ToString()); //make connection with builder
            ...
            using (connection)
            {
                try
                {
                    var createDatabase = "CREATE DATABASE MinionsDB"; //make querry to create database
                    ExecuteCommand(createDatabase, connection); //use method to execute command
                }
                catch (Exception e)
                {
            ...
            builder["initial catalog"] = "MinionsDB"; //add database to builder
            connection = new SqlConnection(builder.ToString()); //make new connection with added name of database MinionsDB
